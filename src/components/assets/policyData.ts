...
export const kuponoData: PolicyDataType = {
    lt: {
        content: [
            {
                type: "list",
                ...
                gap: true,
                list: [
                    "Akių klinikos „Naujas regėjimas“ dovanų kuponas (toliau – Dovanų kuponas) patvirtina išankstinį apmokėjimą ir suteikia teisę Dovanų kupono turėtojui šiose taisyklėse numatyta tvarka įsigyti paslaugų akių klinikoje „Naujas regėjimas“ adresu Savičiaus g. 3A, Vilnius.",
                    "Dovanų kuponas turi būti pateikiamas prieš atsiskaitant už paslaugas.",
                    "Dovanų kuponą galima įsigyti akių klinikoje UAB „Naujas regėjimas“ adresu Savičiaus g. 3A, Vilnius.",
                    "Dovanų kupono nominalas ne mažesnis nei 50 Eur.",
                    "Dovanų kuponas galioja 6 (šešis) mėnesius nuo jo įsigijimo dienos. Dovanų kupono galiojimo pabaigos data yra nurodyta ant Dovanų kupono.",
                    "Dovanų kupono galiojimas nepratęsiamas.",
                    "Jei Dovanų kuponas nebuvo panaudotas galiojimo laikotarpiu, pinigai nėra grąžinami ir laikoma, kad paslauga yra suteikta.",
                    "Dovanų kuponas gali būti perduotas trečiajam asmeniui.",
                    "Dovanų kuponas negali būti keičiamas į pinigus, negali būti grąžinamas.",
                    "Tuo atveju, kai Dovanų kuponu atsiskaitoma už paslaugas, kurių kaina viršija Dovanų kupone nurodytą pinigų sumą, trūkstamą įsigyjamų prekių ar paslaugų kainos dalį galima sumokėti grynaisiais pinigais, kreditine arba debetine kortelėmis. Jeigu paslaugų kaina yra mažesnė už Dovanų kupone nurodytą pinigų sumą, skirtumas negrąžinamas.",
                    "Dovanų kuponas atsiskaityti už paslaugas gali būti panaudotas tik vieną kartą. Pateikus Dovanų kuponą atsiskaityti už paslaugas, Dovanų kuponas jo turėtojui negrąžinamas.",
                    "Tuo atveju, jei grąžinami pinigai už paslaugą, už kurią buvo atsiskaityta Dovanų kuponu, grąžinama ta pačia forma, t. y. Dovanų kuponu.",
                    "Jei Dovanų kuponas yra sugadintas, suteptas, suplėšytas ar kitaip pažeistas ir dėl to nėra galimybės identifikuoti Dovanų kupono numerio, Dovanų kupone nurodytos pinigų sumos dydžio, Dovanų kuponu atsiskaityti už paslaugas negalima. Toks Dovanų kuponas nekeičiamas ir pinigai už jį negrąžinami.",
                    "Pametus ar kitaip praradus Dovanų kuponą, pinigai negrąžinami.",
                    "Įsigyjant Dovanų kuponą PVM sąskaita faktūra neišrašoma. Sąskaita faktūra gali būti išrašoma tik pasinaudojus paslauga. Pirkėjui pageidaujant gali būti išrašomas Dovanų kupono perdavimo–priėmimo aktas.",
                    "Pirkėjas, įsigydamas dovanų kuponą, sutinka su šiomis Dovanų kupono sąlygomis ir taisyklėmis. Pirkėjas, įsigijęs Dovanų kuponą ir vėliau jį perleisdamas kitam asmeniui, įsipareigoja tą asmenį informuoti apie šias sąlygas ir taisykles.",
                    "UAB „Naujas regėjimas“ pasilieka teisę keisti šias Dovanų kupono naudojimo taisykles ir įsipareigoja iš anksto apie tai informuoti interneto tinklapyje www.eyes.lt.",
                    "Prieš naudodami Dovanų kuponą Dovanų kupono turėtojai raginami pasiteirauti dėl Dovanų kupono naudojimo tvarkos telefonu +370 5 264 4444.",
                ],
            },
        ],
    },
        ...
        content: [
            {
                ...
                gap: true,
                list: [
                    "The UAB “Naujas regėjimas” Eye Clinic Gift Voucher (hereinafter referred to as the Gift Voucher) confirms prepayment and entitles the holder to receive services at the “Naujas regėjimas” Eye Clinic, located at Savičiaus St. 3A, Vilnius.",
                    "The Gift Voucher must be presented before payment for services.",
                    "The Gift Voucher can be purchased at the UAB “Naujas regėjimas” Eye Clinic, Savičiaus St. 3A, Vilnius.",
                    "The minimum value of the Gift Voucher is 50 EUR.",
                    "The Gift Voucher is valid for 6 (six) months from the date of purchase. The expiration date is indicated on the voucher.",
                    "The validity of the Gift Voucher cannot be extended.",
                    "If the Gift Voucher is not used within its validity period, funds are not refunded, and the service is considered provided.",
                    "The Gift Voucher may be transferred to a third party.",
                    "The Gift Voucher cannot be exchanged for cash or refunded.",
                    "If the service cost exceeds the value of the Gift Voucher, the remaining amount can be paid in cash, by credit, or debit card. If the service cost is lower than the voucher value, the difference is not refunded.",
                    "The Gift Voucher can be used only once. After payment, it is not returned to the holder.",
                    "If a refund is issued for a service paid for with a Gift Voucher, the refund will be provided in the form of another Gift Voucher.",
                    "If the Gift Voucher is damaged, stained, torn, or otherwise altered, making it impossible to identify its number and value, it becomes invalid and cannot be exchanged or refunded.",
                    "In case of loss or theft, the Gift Voucher will not be refunded.",
                    "When purchasing the Gift Voucher, a VAT invoice is not issued. The invoice can only be issued after the service has been used. Upon request, a Gift Voucher transfer receipt can be provided.",
                    "By purchasing the Gift Voucher, the buyer agrees to these terms and conditions. If transferring the Gift Voucher to another person, the buyer must inform the recipient about these rules.",
                    "UAB “Naujas regėjimas” reserves the right to change these terms and conditions and undertakes to notify customers in advance on the website www.eyes.lt.",
                    "Before using the Gift Voucher, holders are advised to check the terms by calling +370 5 264 44 44.",
                ],
            },
        ],
    },
        ...
        content: [
            {
                ...
                gap: true,
                list: [
                    "Подарочный сертификат клиники зрения „Naujas regėjimas“ (далее – Сертификат) подтверждает предварительную оплату и предоставляет держателю право на получение услуг в клинике зрения „Naujas regėjimas“ по адресу ул. Савичаус 3A, Вильнюс.",
                    "Подарочный сертификат клиники зрения „Naujas regėjimas“ (далее – Сертификат) подтверждает предварительную оплату и предоставляет держателю право на получение услуг в клинике зрения „Naujas regėjimas“ по адресу ул. Савичаус 3A, Вильнюс.",
                    "Сертификат можно приобрести в клинике зрения UAB „Naujas regėjimas“ по адресу ул. Савичаус 3A, Вильнюс.",
                    "Номинальная стоимость сертификата – не менее 50 EUR.",
                    "Сертификат действителен 6 (шесть) месяцев с момента его приобретения. Срок действия указан на самом сертификате.",
                    "Срок действия сертификата не продлевается.",
                    "Если сертификат не был использован в период его действия, деньги не возвращаются, и услуга считается оказанной.",
                    "Сертификат может быть передан другому лицу.",
                    "Сертификат не подлежит обмену на деньги и не может быть возвращен.",
                    "Если стоимость услуг превышает номинал сертификата, разницу можно оплатить наличными, кредитной или дебетовой картой. Если стоимость услуг меньше номинала сертификата, разница не возвращается.",
                    "Сертификат можно использовать только один раз. После оплаты услуг сертификат не возвращается владельцу.",
                    "В случае возврата денег за услугу, оплачиваемую сертификатом, средства возвращаются в той же форме, то есть сертификатом.",
                    "Если сертификат поврежден, испачкан, порван или иным образом испорчен, из-за чего невозможно определить его номер и номинал, он становится недействительным, обмену не подлежит, и деньги не возвращаются.",
                    "В случае потери или кражи сертификата деньги не возвращаются.",
                    "При покупке сертификата счет-фактура с НДС не выдается. Счет-фактура может быть предоставлен только после использования услуги. По запросу покупателя может быть оформлен акт передачи сертификата.",
                    "Покупая сертификат, клиент соглашается с настоящими правилами. Передавая сертификат третьему лицу, покупатель обязуется проинформировать нового владельца о правилах использования.",
                    "UAB „Naujas regėjimas“ оставляет за собой право изменять данные правила и обязуется заранее информировать об этом на сайте www.eyes.lt.",
                    "Перед использованием сертификата владельцу рекомендуется уточнить условия его использования по телефону +370 5 264 44 44.",
                ],
            },
        ],
    },
