    ...
    return (
        <>
            ...
            <div className="flex flex-1 flex-col justify-between">
                ...
                <div className="pc:gap-5 flex justify-between">
                    ...
                    <Link
                        ...
                        className="font-oswald tab:text-sm pc:text-base pc:hover:underline-offset-[2.5px] mr-3 py-0.5 text-sm leading-none font-medium whitespace-nowrap uppercase hover:underline hover:decoration-1 hover:underline-offset-[1.5px]"
                    >
                        {btnName}
                    </Link>
                </div>
